...
CREATE TABLE `clientaccounts` (
  ...
  CONSTRAINT `clientaccounts_ibfk_1` FOREIGN KEY (`customerID`) REFERENCES `customers` (`customerID`)
...
INSERT INTO `clientaccounts` VALUES (1,1,'2016-04-30 06:26:15'),(1,2,'2016-04-30 06:26:23');
